						...
						<form action="nedmin/netting/islem.php" method="POST">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									...
									<!-- giriş yapılmamışsa sepete eklemeyi engelledim -->

                                    <?php if(isset($_SESSION['userkullanici_mail'])&&($uruncek['urun_stok']>=1)  ){?>
						...
						<div class="sharing">
							...
							<div  class="avatock"><span>
								...
								<?php if ($uruncek['urun_stok']>=1) {
									...
									echo"<font size=5px >ÜRÜN KALMADI</font>"; 
								} ?>
...
// kategorisordakinin ismini değiştirdim aynı sorgu
								while($yorumcek=$yorumsor->fetch(PDO::FETCH_ASSOC)) {
									...
									Yorum yazabilmek için lütfen <a style="color:red" href="register">kayıt</a> ol ya da giriş yap.
...
//isimden kaynaklı yukarıdaki database sorgusu ile karışıyordu ismi değiştirince her ürünün kendi resmini çekmeye başladı
              
					$urun_id=$urunaltcek['urun_id'];
					$urunaltfotosor=$db->prepare("SELECT * FROM urunfoto where urun_id=:urun_id ");
					$urunaltfotosor->execute(array(
						'urun_id' => $urun_id
						));

					$urunaltfotocek=$urunaltfotosor->fetch(PDO::FETCH_ASSOC);


//aynı resimleri çekiyordu düzelttim
								...
								<div class="col-md-4">
									<div class="productwrap">
										<div class="pr-img">
											<div class="hot"></div>
											<a href="urun-<?=seo($urunaltcek["urun_ad"]).'-'.$urunaltcek["urun_id"]?>"><img src="<?php echo $urunaltfotocek['urunfoto_resimyol'] ?>" alt="" class="img-responsive"></a>
