	...
	<form action="nedmin/netting/islem.php" method="POST" class="form-horizontal checkout" role="form">
		<div class="row">
			<div class="col-md-6">
				...
				<div class="form-group dob">
					<div class="col-sm-12">
						...
						İsim Soyisim<input type="text" class="form-control"  required="" name="kullanici_adsoyad" value="<?php echo $kullanicicek['kullanici_adsoyad'] ?>">
					</div>
				...
				<div class="form-group dob">
					...
					<div class="col-sm-6">
					   ...
					   <div class="col-sm-6">
						Adres<input type="text" class="form-control" name="kullanici_adres"    value="<?php echo $kullanicicek['kullanici_adres'] ?>">
					</div>
			        <div class="col-sm-6">
						Telefon<input type="text" class="form-control" name="kullanici_gsm"    value="<?php echo $kullanicicek['kullanici_gsm'] ?>">
					</div>
				</div>
			...
			<div class="col-md-6">
				...
				<center><a href="sifre-guncelle"><img width="300" src="https://cdn.dribbble.com/users/43342/screenshots/1064529/robot.gif"></a></center>
			</div>
		</div>
	</div>
</form>
