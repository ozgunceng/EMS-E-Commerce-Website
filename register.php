		...
		<div class="row">
			<div class="col-md-6">
				...
				<div class="form-group">
					<div class="col-sm-12">
						<input type="text" class="form-control" required="" name="kullanici_tc"  placeholder="Lütfen TC Kimlik Numaranızı Girin...">
					</div>
				</div>
				...
				<div class="form-group">
					<div class="col-sm-12">
						<input type="text" class="form-control" required="" name="kullanici_gsm"  placeholder="Telefon Giriniz...">
					</div>
				</div>
			...
			<div class="col-md-6">
				...
				<center><img width="400" src="https://images.app.goo.gl/ohKwVW5uLBUY4vMw7"></center>
			</div>
		</div>
	</div>
</form>
