			...
			<div class="container">
				<div class="row">
					<div class="col-xs-6 col-md-4 main-logo">
						<a href="index.php"><img width="200" height="200" src="<?php echo $ayarcek['ayar_logo'] ?>" alt="logo" class="logo img-responsive"></a>
					</div>
					<div class="col-md-8">
						<div class="pushright">
							<div class="top">
								...
								<div class="regwrap">
									<div class="row">
										<div class="col-md-6 regform">
											...
											<form action="nedmin/netting/islem.php" method="POST" role="form"  >
												...
												<div class="form-group">
													<input type="text" class="form-control" name="kullanici_mail" id="username" placeholder="Kullanıcı Adı (Mail)">
												</div>
										...
										<div class="col-md-6">
											...
											<p>
												Hala kaydolmadın mı ? Fırsatları kaçırmamak için hemen kayıt ol !
											</p>
									...
									<div class="row">
										<div class="col-md-12">
											...
											<form action="arama" method="POST"  class="form-horizontal" role="form">
												...
												<button name="arama" class="btn btn-default  btn-red" >Ara</button>
													<div class="col-sm-10">
...
//url alanı bos degilse
											if(!empty($menucek['menu_url'])){
												...
												echo $menucek['menu_url'];
													...
													echo "sayfa-".seo($menucek['menu_seourl']);
...
// ÜRÜN RESİMLERİNİ BU SORGU İLE GETİRDİM
...
// RESİM SORGUM
					...
					?>
												...
												<tr>
													...
													<td><?php echo $sepetcek['urun_adet']; echo "&nbsp;"."Adet"; ?></td>
													<td><?php echo $uruncek['urun_fiyat']; ?> </td>
													<td><!-- <a href=""><i class="fa fa-times-circle fa-2x"></i></a> silme tuşunu çıkardım--></td>
												</tr>
